...
operations = ["Replication", "ALL", "Blur", "Noise", "Blending", "UnsharpMasking", "Composition", "ThresholdCombination", "Saliency", "SmoteImg", "SmoteImt", "Composition", "Composition"]
    ...
    for operation in range(0,13):
        for desc in descriptors:
            for met in methods:
                ...
                allAccuracy = []
                for i in range(0, 3):
                    alg = directory+"Generation_"+str(generation)+"/"+str(operation)+"-"+algorithms[i]+"_"
                    if which == 0:
                ...
                if os.path.exists(fileName):
                    ...
                    if which == 0:
                        plt.savefig(directory+str(generation)+"-"+str(operation)+"_"+desc+"_"+met+"_FScore.png")
                    else:
                        plt.savefig(directory+str(operation)+"_"+desc+"_"+met+"_BalancedAccuracy.png")
