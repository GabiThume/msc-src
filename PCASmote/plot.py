...
for operation in range(0,9):
    for desc in descriptors:
        for met in methods:
            ...
            color = ["r", "g", "b"]
            labels = ["Original", 'Imagens Artificiais']
            ...
            if os.path.exists(fileName):
                ...
                if which == 0:
                    plt.savefig("Desbalanced/analysis/"+str(operation)+"-"+desc+"_"+met+"_FScore.png")
                else:
                    plt.savefig("Desbalanced/analysis/"+str(operation)+"-"+desc+"_"+met+"_BalancedAccuracy.png")
