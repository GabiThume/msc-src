...
# second best fscore BIC + Luminance
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/praia-montanha/ /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/praia-montanha/original/ 0 1 > /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/praia-montanha/saida_segundo_melhor.txt;
# biggest std CCV + Intensity
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/praia-montanha/ /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/praia-montanha/original/ 2 0 > /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/praia-montanha/saida_pior.txt;
...
# biggest std HOG + MSB
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/elefante-cavalo/ /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/elefante-cavalo/original/ 6 3 > /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/elefante-cavalo/saida_pior.txt;
...
# biggest std CCV + Intensity
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/leafs/ /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/leafs/original/ 2 0 > /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/leafs/saida_pior.txt;
...
# biggest std LBP + Intensity
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/naturaly_unbalanced/BigBen-EiffelTower-PisaTower/ /media/gabi/Dados\ 1/data/experiments/datasets/naturaly_unbalanced//BigBen-EiffelTower-PisaTower/original/ 5 0 > /media/gabi/Dados\ 1/data/experiments/datasets/naturaly_unbalanced//BigBen-EiffelTower-PisaTower/saida_pior.txt;
...
# biggest std LBP + Luma
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/naturaly_unbalanced/eiffel-ponte/ /media/gabi/Dados\ 1/data/experiments/datasets/naturaly_unbalanced/eiffel-ponte/original/ 5 5 > /media/gabi/Dados\ 1/data/experiments/datasets/naturaly_unbalanced/eiffel-ponte/saida_pior.txt;
...
# biggest std BIC + Gleam
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/naturaly_unbalanced/eiffel-41/ /media/gabi/Dados\ 1/data/experiments/datasets/naturaly_unbalanced/eiffel-41/original/ 0 2 > /media/gabi/Dados\ 1/data/experiments/datasets/naturaly_unbalanced/eiffel-41/saida_pior.txt;
...
# biggest std CCV + Intensity
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/naturaly_unbalanced/bigben-museu/ /media/gabi/Dados\ 1/data/experiments/datasets/naturaly_unbalanced/bigben-museu/original/ 2 0 > /media/gabi/Dados\ 1/data/experiments/datasets/naturaly_unbalanced/bigben-museu/saida_pior.txt;
...
# biggest std LBP + MSB
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/Corel1000/ /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/Corel1000/original/ 5 3 > /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/Corel1000/saida_pior.txt
...
# biggest std HOG + MSB
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/tropical_fruits1400/ /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/tropical_fruits1400/original/ 6 3 > /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/tropical_fruits1400/saida_pior.txt;
...
# biggest std GCH + Luma
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/Caltech_600/ /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/Caltech_600/original/ 1 5 > /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/Caltech_600/saida_pior.txt
...
# biggest std CCV + MSB
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/dtd-3/ /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/dtd-3/original/ 2 3 > /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/dtd-3/saida_pior.txt
...
# biggest std BIC + Intensity
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/leafsnap-1000/ /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/leafsnap-1000/original/ 0 0 > /media/gabi/Dados\ 1/data/experiments/datasets/multiclasses/leafsnap-1000/saida_pior.txt;
...
# biggest std HOG + Luma
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/muitas_imagens/shark-fish/ /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/muitas_imagens/shark-fish/original/ 6 5 > /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/muitas_imagens/shark-fish/saida_pior.txt;
...
# biggest std BIC + Intensity
./bin/experiment /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/muitas_imagens/deer-ship/ /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/muitas_imagens/deer-ship/original/ 0 0 > /media/gabi/Dados\ 1/data/experiments/datasets/duas_classes/muitas_imagens/deer-ship/saida_pior.txt;
